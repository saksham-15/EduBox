...
document.addEventListener('DOMContentLoaded', () => {
  ...
  document.addEventListener('keydown', function(event) {
    ...
    if (validKeys.includes(key)) {
      ...
      addMessageToChat(answer, 'user'); // show user answer in chat
      submitQuizAnswer(answer); // submit answer to backend
    }
  });

  // --- ADDITIONAL HELPER ---
  function addMessageToChat(text, sender) {
    // Implement according to your logic for inserting messages
